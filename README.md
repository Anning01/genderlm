...
- **CPU**: 13th Gen Intel(R) Core(TM) i9-13900K (32 threads)
- **GPU**: NVIDIA GeForce RTX 4090 (Driver 580.95.05, CUDA 13.0)
- **启动命令**: `gunicorn api:app --workers 4 --worker-class uvicorn.workers.UvicornWorker --bind 0.0.0.0:8000`

> ⚠️ **注意**: 高并发场景下务必使用 `onnxruntime-gpu`，否则并发性能会受到严重影响。

### 压测结果

**FairFace API 压测报告 (单图识别)**

| 并发 | QPS | 平均延迟 | P99延迟 | 成功率 |
|------|-----|----------|---------|--------|
| 50 | 395.33 | 123.47ms | 338.96ms | 100.0% |
| 100 | 384.06 | 247.53ms | 856.23ms | 100.0% |
| 200 | 396.22 | 457.82ms | 1239.13ms | 100.0% |
| 300 | 384.78 | 669.07ms | 1709.41ms | 100.0% |

**FairFace 批量上传压测报告**

| 并发 | 批次QPS | 图片QPS | 平均延迟 | P99延迟 | 成功率 | 总图片数 |
|------|---------|---------|----------|---------|--------|----------|
| 20 | 35.22 | 445.58 | 540.33ms | 1788.05ms | 100.0% | 3795 |
| 50 | 42.01 | 505.47 | 1066.07ms | 5980.88ms | 99.33% | 3610 |
| 100 | 32.27 | 423.63 | 2593.17ms | 8902.14ms | 99.67% | 3938 |
| 150 | 34.42 | 436.39 | 3067.93ms | 8495.24ms | 100.0% | 3804 |
